...
/**
 * Define a interface para criação de classes que implementam a exportação de
 * uma lista de produtos para formatos específicos como HTML, CSV, Markdown,
 * etc.
 *
...
public interface ExportadorListaProduto {
    ...
    /**
     * Retorna o código para abertura de uma coluna de uma tabela em um formato
     * de dados específico.
     *
    ...
    /**
     * Retorna o código para fechamento de uma coluna de uma tabela em um
     * formato de dados específico.
     *
     * @return
     */
